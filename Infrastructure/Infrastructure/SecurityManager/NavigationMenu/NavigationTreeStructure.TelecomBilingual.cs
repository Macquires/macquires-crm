...
public static partial class NavigationTreeStructure
{
    private static readonly Dictionary<string, (string Ar, string En)> TelecomLeafLabels =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["/executive/commandcenter"] = ("مركز القيادة السيادي", "Sovereign Command Center"),
            ["/executive/commandcenter?tab=scorecard"] = ("لوحة المؤشرات التنفيذية", "Executive Scorecard"),
            ["/executive/commandcenter?tab=network"] = ("تحليلات عمليات الشبكة", "Network Operations Analytics"),
            ["/executive/commandcenter?tab=mis"] = ("السجلات المالية وMIS", "Financial Ledgers & MIS"),
            ["/executive/commandcenter?tab=operations"] = ("مراقبة العمليات الفورية", "Operations Real-Time Monitor"),
            ["/executive/commandcenter?tab=workforce"] = ("إنتاجية القوى العاملة", "Workforce Productivity"),
            ["/executive/commandcenter?tab=alerts"] = ("الحوكمة والتنبيهات والتدقيق", "Governance, Alerts & Audit"),
            ...
            ["/telecom/unifiedsearch"] = ("البحث الموحد — استقبال", "Unified search — customer care"),
            ["/telecom/callcentertariffs"] = ("دليل الباقات والتعرفات 2026", "Service tariffs guide (2026)"),
            ...
            ["/telecom/productcatalog"] = ("دليل الباقات والتعرفات", "Plans & tariffs catalog"),
    ...
    private static readonly Dictionary<string, (string Ar, string En)> TelecomModuleLabels =
        new(StringComparer.Ordinal)
        {
            ...
            ["مركز قيادة الإدارة العليا"] = ("مركز القيادة السيادي", "Sovereign Command Center"),
            ...
            ["مركز الاتصال"] = ("مركز الاتصال", "Call center"),
        };
