-- §10 Termination — showroom request + BackOffice approve + execute.

DECLARE @PermRequest nvarchar(128) = N'telecom.line.termination_request';
...
DECLARE @PermApprove nvarchar(128) = N'telecom.line.termination_approve';
...
DECLARE @PermExec nvarchar(128) = N'telecom.line.termination';
