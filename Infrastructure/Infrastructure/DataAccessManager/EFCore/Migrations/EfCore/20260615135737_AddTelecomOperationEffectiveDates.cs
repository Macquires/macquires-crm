        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MigrationEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    TargetOfferName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    ConfirmedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActivationEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReconnectEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RefundEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BadDebtEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeviceSaleEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExternalCorrelationId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SimSwapEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    PortInMsisdn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DonorOperatorCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberChangeEffectiveDateUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryBulkImportJob_BranchId",
