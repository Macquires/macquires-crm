-- §8 Suspension — showroom request + BackOffice approve + execute.

DECLARE @PermRequest nvarchar(128) = N'telecom.line.suspension_request';
...
DECLARE @PermApprove nvarchar(128) = N'telecom.line.suspension_approve';
...
DECLARE @PermExec nvarchar(128) = N'telecom.line.suspension';
