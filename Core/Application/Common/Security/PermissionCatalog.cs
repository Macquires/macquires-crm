...
public static class PermissionCatalog
{
    ...
    // GLOBAL HARDENING: PBAC Fine-Grained Permissions
    public const string FinanceBdrView = "Permission.Finance.Bdr.View";
    public const string FinanceBdrExecute = "Permission.Finance.Bdr.Execute";
    ...
    [
        ...
        new(TelecomLineSimSwapRequest, "Telecom", "طلب تبديل شريحة (نقطة البيع)", "Submit SIM swap request from POS"),
        ...
        new(TelecomLineTransferRequest, "Telecom", "طلب نقل ملكية من نقطة البيع (TKO)", "Submit ownership transfer request (TKO)"),
        new(TelecomLineChangeNumber, "Telecom", "تغيير رقم خط (CNR) — تنفيذ كامل", "Perform internal MSISDN change (CNR)"),
        new(TelecomLineChangeNumberRequest, "Telecom", "طلب تغيير رقم (نقطة البيع)", "Submit change-number request from POS"),
        ...
        new(TelecomLineTerminationRequest, "Telecom", "طلب إنهاء خط (نقطة البيع)", "Submit line termination from POS"),
        ...
        new(TelecomLineSuspensionRequest, "Telecom", "طلب حظر خط (نقطة البيع)", "Submit line suspension from POS"),
        ...
        new(TelecomLineReconnectRequest, "Telecom", "طلب إعادة تفعيل (نقطة البيع)", "Submit reconnect from POS"),
        ...
        new(TelecomDeviceSellRequest, "Telecom", "طلب بيع جهاز من نقطة البيع", "Submit device sale from POS"),
        ...
        new(TelecomLineRefundRequest, "Telecom", "طلب استرداد مالي (نقطة البيع)", "Submit refund request from POS"),
        ...
        new(TelecomLineCollectionRequest, "Telecom", "طلب تحصيل من نقطة البيع", "Submit collection request from POS"),
        ...
        new(FinanceBdrView, "BackOffice.Security", "رؤية تبويب المالية والديون المعدومة", "View Finance and BDR Tabs"),
        new(FinanceBdrExecute, "BackOffice.Security", "اعتماد ومعالجة طلبات BDR", "Execute BDR Claim/Approve/Reject"),
    ...
    public static IReadOnlyDictionary<string, IReadOnlyList<string>> DefaultRoleGrants { get; } =
        new Dictionary<string, IReadOnlyList<string>>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [TelecomEnterpriseRoleMatrix.RoleFinancialSupervisor] = 
            [
                CustomerView,
                FinanceBdrView,
                FinanceBdrExecute,
            ...
            [TelecomEnterpriseRoleMatrix.RoleNetworkTechnicalAdmin] = 
            [
                CustomerView,
            ...
            [TelecomEnterpriseRoleMatrix.RoleOperationsManager] = All.Select(p => p.Key).ToList(),
